...
public class RentEzTest extends TestCase {
	...
	public void testGetBuyItems() {
	}

	public void testGetClient() {
	}

	public void testBeginAdminTransaction() {
	}

	public void testGetRentalItemType() {
	}
	
	public void testBeginClientTransactionStringString() {
	}
	
	public void testBeginClientTransactionStringStringMyDate() {
	}

	public void testContainsHireItemTypeAnywhere() {
	}

	public void testContainsHireItemType() {
	}

	public void testGetSalesItemType() {
	}

	public void testRemoveForRepair() {
	}

	public void testReturnFromRepair() {
	}

	public void testForMaintenance() {
	}

	public void testGetAllIdentifedHireItems() {
	}

	public void testRentalItemTypeFor() {
	}

	public void testGetAdminStaff() {
	}

	public void testRemoveRentalItemType() {
	}
	...
	public void testCreateItemRestriction() {
	}

	public void testGetPendingClientTransactions() {
	}

	public void testResumeClientTransaction() {
	}

	public void testGetPendingAdminTransactions() {
	}

	public void testRemovePendingClientTransaction() {
	}

	public void testResumeAdminTransaction() {
	}

	public void testRemovePendingAdminTransaction() {
	}

	public void testApplyRestrictionToItem() {
	}

	public void testGetItemsNeedingRepair() {
	}
