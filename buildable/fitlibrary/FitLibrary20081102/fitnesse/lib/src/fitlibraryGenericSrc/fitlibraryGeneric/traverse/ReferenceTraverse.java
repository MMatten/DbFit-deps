...
public class ReferenceTraverse extends Traverse {
    ...
    private Object getObject(Row row, int cellNo, Object object, TestResults testResults) {
        boolean last = false;
    ...
    private Object getReferencedObject(Cell cell, Object object, boolean last, TestResults testResults) {
        if (object instanceof List)
            return getElementOfList(cell,(List)object);
    ...
    private Object getElementOfMap(Cell cell, Map map, TestResults testResults) {
    ...
    private Object getElementOfList(Cell cell, List list) {
        Integer index = MAP_WORD_TO_INT.get(cell.textLower(this));
    ...
    private CalledMethodTarget getGetterTarget(Cell cell, String name, Object sut, boolean considerContext, TestResults testResults) {
    	try {
    		return LookupMethodTarget.findGetterUpContextsToo(asTypedObject(sut), this, name, considerContext);
