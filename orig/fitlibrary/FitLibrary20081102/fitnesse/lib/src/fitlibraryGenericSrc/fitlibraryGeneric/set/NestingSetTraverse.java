...
public class NestingSetTraverse extends Traverse {
	...
	public Object interpretAfterFirstRow(Table table, TestResults testResults) {
        ...
        ArrayList<Object> listOfActuals = new ArrayList<Object>(set);
    ...
    private void matchActual(Cell cell, Parser adapter, List listOfActuals, int tableSize, TestResults testResults) throws Exception {
