...
public class RentalTest extends TestCase {
	...
	/*
	 * Class under test for void Rental(Reservation, Client, StaffMember)
	 */
	public void testRentalReservationClientStaffMember() {
		//assertEquals(rental.Re)
		
	}

	/*
	 * Class under test for void Rental(RentalItemType, int, MyDate, Duration, Client, StaffMember)
	 */
	public void testRentalRentalItemTypeintMyDateDurationClientStaffMember() {
	}
